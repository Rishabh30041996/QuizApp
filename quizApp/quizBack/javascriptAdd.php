...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO javascriptquestions (";
	...
	if($result){
		foreach($choice as $option => $value){
			if($value != ""){
				...
				$query = "INSERT INTO javascriptoptions (";
				$query .= "question_number,is_correct,option_)";
				$query .= " VALUES (";
...
<body>
	...
	<main>
			<div class="container">
				...
				<form method="POST" action="javascriptadd.php">
